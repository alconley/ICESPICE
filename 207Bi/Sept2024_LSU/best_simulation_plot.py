...
def demo_plot_2():
    noICESPICE_root_file = "./207Bi/Sept2024_LSU/geant_sim/RadDecay_z83_a207_e0keV_f8mm_g0mm_n100000000_PIPS1000_AllProcesses_SiWindow50nm_Source500nmThick_run81.root"
    ICESPICE_root_file = "./207Bi/Sept2024_LSU/geant_sim/ICESPICE_RadDecay_z83_a207_e0keV_f70mm_g30mm_n1000000000_PIPS1000_AllProcesses_SiWindow50nm_Source500nmThick_run79.root"
...
def sac_ssap_2025():
    ...
    # Create a figure and GridSpec with 4 rows and 1 column
    fig = plt.figure(figsize=(2.8919330289193304, 3))  # Adjust the height for better visualization
    gs = gridspec.GridSpec(3, 1, figure=fig, height_ratios=[3, 3, 1], hspace=0.05)
    ...
    axs = [axs_exp_comparison, axs_icepsice_sim, axs_icepsice_sim_residuals]
    ...
    axs[1].stairs(values=exp_hist_withICESPICE, edges=exp_bin_edges_withICESPICE, color="#088a45", label=r"$^{207}$Bi with ICESPICE", linewidth=linewidth)
    ...
    scaling(ICESPICE_exp_bin_centers, ICESPICE_exp_hist_data, ICESPICE_exp_hist_uncertainity, ICSPICE_sim_bin_centers, ICSPICE_sim_bin_edges, ICSPICE_sim_hist, ICSPICE_sim_hist_uncertainity, ICESPICE_threshold_ranges, ICESPICE_scale_range, axs[1], axs[2])

    labels = [r'(a)', r'(b)', r'(c)']  # Labels for each subplot
    ...
    plt.savefig("./207Bi/Sept2024_LSU/sac_ssap_2025_poster.pdf")
    plt.show()
